...
/**
 * Field scaffolding (shadcn "field") — label + control + description/error
 * wiring with horizontal/responsive orientations, plus FieldSet/FieldGroup
 * for composing whole forms.
 */
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "has-data-[state=checked]:bg-primary/5 has-data-[state=checked]:border-primary/40",
        className,
      )}
      {...props}
    />
