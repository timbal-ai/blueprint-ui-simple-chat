import { RiAddFill, RiFilter3Fill, RiMenuLine, RiTeamLine } from "@remixicon/react";
...
/**
 * HR template header — the same breadcrumb + title + action-row recipe as
 * `DashboardHeader` and `MedicalHeader`, with people-flavored actions.
 */
export function HrHeader({ onMenuClick }: { onMenuClick?: () => void } = {}) {
  return (
    <header className="flex w-full flex-col gap-2">
      ...
      <Breadcrumb>
        ...
        <BreadcrumbItem current icon={RiTeamLine}>
          HR Team
        </BreadcrumbItem>
      </Breadcrumb>
