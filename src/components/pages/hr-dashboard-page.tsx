...
/**
 * HrDashboardPage — the reference DASHBOARD template: header with actions
 * (Export + a FormSheet-backed "Add employee"), a 3-up KPI band with vibrant
 * delta badges, a MetricTrendCard + RosterCard band, an approve/dismiss
 * recommendations band, a composed line+bar chart paired with a donut
 * breakdown, an engagement score ring + hiring-activity heatmap band, and a
 ...
 * trend/roster band → RecommendationCards → ChartCards → FilteredTable) and
 * the spacing rhythm. Cut bands you don't need; never flatten a band into
 * hand-rolled divs.
 */
