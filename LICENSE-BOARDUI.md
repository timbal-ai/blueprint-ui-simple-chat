...
`src/hooks/use-count-up.ts`, `public/ai-chat` (plugin SVG marks only) and the
...
- **Pro** items (chart cards, agent UI, calendar, project-board, the page templates) are licensed
